...
class TestMedia(MnemosyneTest):
    ...
    def restart(self):
        ...
        self.mnemosyne.components.append(("test_media", "Widget"))
    ...
    def test_external_media(self):
        fact_data = {
            "f": '<img src="http://www.chine-nouvelle.com/jdd/public/ct/pinyinaudio/shu4.mp3"',
            "b": "answer",
        }
        card_type = self.card_type_with_id("1")
        card = self.controller().create_new_cards(
    ...
    def test_card_edit_add(self):
        ...
        fact_data = {
            "f": 'edited <img src="%s"> <img src="%s">' % ("a.ogg", full_path),
            "b": "answer",
        }
        self.controller().edit_card_and_sisters(
            card,
