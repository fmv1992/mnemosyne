...
class TestCardType(MnemosyneTest):
    ...
    def test_database(self):
        ...
        assert (
            card_type_out.fact_views[0].a_fact_keys
            == card_type.fact_views[0].a_fact_keys
        )
        assert (
            card_type_out.fact_views[0].a_on_top_of_q
    ...
    def test_delete(self):
        ...
        assert (
            card_type_out.fact_views[1].a_fact_keys
            == card_type_2.fact_views[1].a_fact_keys
        )
        assert (
            card_type_out.fact_views[1].a_on_top_of_q
