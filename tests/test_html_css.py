...
class TestHtmlCss(MnemosyneTest):
    ...
    def test_1(self):
        self.config()["font"] = {
            "1": {
                "f": "Courier New,10,-1,5,50,1,0,0,0,0",
                "b": "Courier New,10,-1,5,25,2,0,0,0,0",
            },
            "3": {
                "p": "Courier New,10,-1,5,75,0,0,0,0,0",
                "t": "Courier New,10,-1,5,50,0,0,0,0,0",
                "f": "Courier New,10,-1,5,50,0,0,0,0,0",
            },
            "2": {
                "f": "Courier New,10,-1,5,50,0,1,0,0,0",
        ...
        card2 = self.controller().create_new_cards(
            fact_data, card_type, grade=-1, tag_names=["default"]
        )[0]
        fact_data = {"f": "question", "p_1": "", "m_1": "answer"}
        card_type = self.card_type_with_id("3")
        card3 = self.controller().create_new_cards(
            fact_data, card_type, grade=-1, tag_names=["default"]
        )[0]
