...
class TestScheduler(MnemosyneTest):
    ...
    def test_midnight_UTC(self):
        ...
        time.tzset()
        midnight_UTC = int(
            time.mktime(datetime.datetime(2012, 1, 14, 0, 0, 0).timetuple())
        )
    ...
    def test_1(self):
        ...
        card_3 = self.controller().create_new_cards(
            fact_data, card_type, grade=2, tag_names=[]
        )[0]
        fact_data = {"f": "4", "b": "b"}
    ...
    def test_learn_ahead_2(self):
        ...
        for i in range(3):
            ...
            self.database().update_card(card)
        fact_data = {"f": "2", "b": "b"}
        new_card = self.controller().create_new_cards(
            fact_data, card_type, grade=-1, tag_names=["default"]
        )[0]
    ...
    def test_6(self):
        ...
        for i in range(10):
            ...
            card = self.controller().create_new_cards(
                fact_data, card_type, grade=4, tag_names=["default" + str(i)]
            )[0]
    ...
    def test_last_rep_to_interval_string(self):
        ...
        sch.last_rep_to_interval_string(calendar.timegm(last_rep.timetuple()))
    ...
    def test_prefetch(self):
        ...
        card_type = self.card_type_with_id("1")
        card_0 = self.controller().create_new_cards(
            fact_data, card_type, grade=-1, tag_names=["default"]
        )[0]
