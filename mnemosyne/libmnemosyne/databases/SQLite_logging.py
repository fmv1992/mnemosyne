...
class SQLiteLogging(object):
    ...
    def dump_to_science_log(self):
        ...
        for cursor in self.con.execute(
            """select _id, event_type, timestamp,
    ...
    def archive_old_logs(self):
        ...
        arch_con.close()
        # Needed for Android.
        self.con.execute("PRAGMA temp_store_directory='%s';" % (archive_dir,))
        # Transfer old logs.
        script = string.Template(
            """
