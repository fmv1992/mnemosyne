...
class TestActivateCards(MnemosyneTest):
    ...
    def test_activate_cards_1(self):
        ...
        c.deactivated_card_type_fact_view_ids = set(
            [(card_type_2.id, card_type_2.fact_views[0].id)]
        )
        c._tag_ids_active = set(
            [self.database().get_or_create_tag_with_name("default")._id]
        )
        ...
        self.controller().create_new_cards(
            fact_data, card_type_2, grade=-1, tag_names=["default2"]
        )
        c.deactivated_card_type_fact_view_ids = set()
        c._tag_ids_active = set(
            [self.database().get_or_create_tag_with_name("default2")._id]
        ...
        self.controller().create_new_cards(
            fact_data, card_type_2, grade=-1, tag_names=["default3", "default4"]
        )
        c.deactivated_card_type_fact_view_ids = set()
        c._tag_ids_active = set(
    ...
    def test_activate_cards_2(self):
        ...
        card_type_1 = self.card_type_with_id("1")
        self.controller().create_new_cards(
            fact_data, card_type_1, grade=-1, tag_names=["active", "forbidden"]
        )
        assert self.database().active_count() == 1
    ...
    def test_activate_cards_3(self):
        ...
        card = self.controller().create_new_cards(
            fact_data, card_type_1, grade=-1, tag_names=["tag1"]
        )[0]
        ...
        fact_data = {"f": "question2", "b": "answer2"}
        card_type_2 = self.card_type_with_id("2")
        cards = self.controller().create_new_cards(
            fact_data, card_type_2, grade=-1, tag_names=["tag2"]
        )
    ...
    def test_activate_cards_4(self):
        ...
        card_type_1 = self.card_type_with_id("1")
        card = self.controller().create_new_cards(
            fact_data, card_type_1, grade=-1, tag_names=["tag"]
        )[0]
        self.review_controller().show_new_question()
    ...
    def test_activate_cards_new(self):
        ...
        card_type_1 = self.card_type_with_id("1")
        self.controller().create_new_cards(
            fact_data, card_type_1, grade=-1, tag_names=["forbidden"]
        )
        assert self.database().active_count() == 1
    ...
    def test_activate_cards_bulk_edit(self):
        ...
        card_type_1 = self.card_type_with_id("1")
        card = self.controller().create_new_cards(
            fact_data, card_type_1, grade=-1, tag_names=["allowed"]
        )[0]
        assert self.database().active_count() == 1
        ...
        c.deactivated_card_type_fact_view_ids = set()
        c._tag_ids_active = set(
            [self.database().get_or_create_tag_with_name("allowed")._id]
        )
        c._tag_ids_forbidden = set(
            [self.database().get_or_create_tag_with_name("forbidden")._id]
        )
    ...
    def test_activate_cards_5(self):
        ...
        card_type_1 = self.card_type_with_id("1")
        self.controller().create_new_cards(
            fact_data, card_type_1, grade=-1, tag_names=["b"]
        )
    ...
    def test_inactive_parent(self):
        ...
        card_type_1 = self.card_type_with_id("1")
        self.controller().create_new_cards(
            fact_data, card_type_1, grade=-1, tag_names=["dummy"]
        )
        ...
        c.deactivated_card_type_fact_view_ids = set()
        c._tag_ids_active = set(
            [self.database().get_or_create_tag_with_name("dummy")._id]
        )
        c._tag_ids_forbidden = set(
            [self.database().get_or_create_tag_with_name("a")._id]
        )
        ...
        fact_data = {"f": "question3", "b": "answer3"}
        self.controller().create_new_cards(
            fact_data, card_type_1, grade=-1, tag_names=["a::b"]
        )

        assert self.database().active_count() == 1
        fact_data = {"f": "question4", "b": "answer4"}
        self.controller().create_new_cards(
            fact_data, card_type_1, grade=-1, tag_names=["dummy::b"]
        )
        assert self.database().active_count() == 2
