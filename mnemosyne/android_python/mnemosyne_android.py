...
mnemosyne.components = [
    ...
    ("mnemosyne.android_python.database_maintenance", "AndroidDatabaseMaintenance"),
    ...
    ("mnemosyne.libmnemosyne.controllers.default_controller", "DefaultController"),
    (
    ...
    ("mnemosyne.libmnemosyne.statistics_pages.retention_score", "RetentionScore"),
    ...
    ("mnemosyne.android_python.main_widget", "MainWdgt"),
    ("mnemosyne.android_python.configuration", "AndroidConfiguration"),
    ("mnemosyne.android_python.android_render_chain", "AndroidRenderChain"),
    ("mnemosyne.android_python.sync_dlg", "SyncDlg"),
    ("mnemosyne.android_python.activate_cards_dlg", "ActivateCardsDlg"),
]

mnemosyne.gui_for_component["ScheduledForgottenNew"] = [
    ("mnemosyne.android_python.review_widget", "ReviewWdgt")
]
mnemosyne.gui_for_component["NewOnly"] = [
    ("mnemosyne.android_python.review_widget", "ReviewWdgt")
]
mnemosyne.gui_for_component["CramAll"] = [
    ("mnemosyne.android_python.review_widget_cramming", "ReviewWdgtCramming")
]
...
def start_mnemosyne(args):
    mnemosyne.initialise(data_dir=args["data_dir"], filename=args["filename"])
