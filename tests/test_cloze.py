...
class TestCloze(MnemosyneTest):
    ...
    def setup_method(self):
        ...
        self.mnemosyne.components.append(("test_cloze", "Widget"))
    ...
    def test_convert(self):
        ...
        self.controller().change_card_type(
            [fact], card_type, new_card_type, {"text": "f"}
        )
    ...
    def test_convert_2(self):
        ...
        self.controller().edit_card_and_sisters(
            card, new_fact_data, new_card_type, ["default"], {"f": "text"}
        )
    ...
    def test_henrik_1(self):
        card_type = self.card_type_with_id("5")
        fact_data = {
            "text": """I [1302] ble [Ingebjorg] (datteren til [Eufemia]
...
gammel...."""
    ...
    def test_henrik_2(self):
        card_type = self.card_type_with_id("5")
        fact_data = {
            "text": """Since his death in [1992], [Francis Bacon]'s
...
third in 2008"""
    ...
    def test_clone(self):
        card_type = self.card_type_with_id("5")
        card_type = self.controller().clone_card_type(card_type, ("5 clone"))
        fact_data = {"text": """bla [cloze:hint] [other cloze:other_hint]"""}
        card = self.controller().create_new_cards(
            fact_data, card_type, grade=-1, tag_names=["default"]
        )[0]
