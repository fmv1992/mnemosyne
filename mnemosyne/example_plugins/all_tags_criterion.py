...
class AllTagsCriterionPlugin(Plugin, PrintMethodCalls, HiGiver):
    ...
    def activate(self):
        ...
        wdg = AllTagsCriterionWdgt(self.component_manager)
        self.component_manager.register(wdg)
...
class AllTagsCriterionWdgt(QtWidgets.QWidget, CriterionWidget):
    ...
    def __init__(self, **kwds):
        ...
        self.layout.addWidget(
            QtWidgets.QLabel(_("Activate cards from these card types:"))
        )
        ...
        self.layout.addWidget(
            QtWidgets.QLabel(_("Cards must have ALL these tags:"))
        )
