...
class TestRenderChain(MnemosyneTest):
    ...
    def test_add_filter(self):
        ...
        assert type(self.render_chain()._filters[0]) != type(
            MyFilter(self.mnemosyne.component_manager)
        )
    ...
    def test_add_filter_order(self):
        ...
        assert type(self.render_chain()._filters[0]) == type(
            MyFilter1(self.mnemosyne.component_manager)
        )

        assert type(self.render_chain()._filters[1]) == type(
            MyFilter3(self.mnemosyne.component_manager)
        )

        assert type(self.render_chain()._filters[2]) == type(
            MyFilter4(self.mnemosyne.component_manager)
        )

        assert type(self.render_chain()._filters[3]) == type(
            MyFilter2(self.mnemosyne.component_manager)
        )
